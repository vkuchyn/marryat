...
public final class ReservationControllerSystemTest {
    ...
    public void initRooms() {
        jdbcTemplate.update("DELETE FROM room WHERE id IN (1, 2)");
        jdbcTemplate.update("INSERT INTO room (id, name) VALUES (?, ?)", new Object[]{1L, "23A"});
        jdbcTemplate.update("INSERT INTO room (id, name) VALUES (?, ?)", new Object[]{2L, "23B"});
    }
